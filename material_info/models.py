...
class Material(models.Model):
    ...
    code = models.CharField("代号", max_length=32, blank=True, default="", null=True)
    standards = models.CharField("规格", max_length=64, blank=True, default="", null=True)
    exe_standard = models.CharField("执行标准", max_length=64, blank=True, default="", null=True)
    ...
    remarks = models.CharField("备注", max_length=255, blank=True, default="", null=True)
